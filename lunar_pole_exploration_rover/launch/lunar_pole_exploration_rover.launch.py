...
def generate_launch_description():
    ...
    ros_gz_bridge = Node(
            ...
            arguments=[
                ...
                '/model/lunar_pole_exploration_rover/aft_cam_left/camera_info@sensor_msgs/msg/CameraInfo@ignition.msgs.CameraInfo',
                '/model/lunar_pole_exploration_rover/aft_cam_right/camera_info@sensor_msgs/msg/CameraInfo@ignition.msgs.CameraInfo',
                '/model/lunar_pole_exploration_rover/nav_cam_left/camera_info@sensor_msgs/msg/CameraInfo@ignition.msgs.CameraInfo',
                '/model/lunar_pole_exploration_rover/nav_cam_right/camera_info@sensor_msgs/msg/CameraInfo@ignition.msgs.CameraInfo',
                '/model/lunar_pole_exploration_rover/haz_cam_left_front/camera_info@sensor_msgs/msg/CameraInfo@ignition.msgs.CameraInfo',
                '/model/lunar_pole_exploration_rover/haz_cam_left_rear/camera_info@sensor_msgs/msg/CameraInfo@ignition.msgs.CameraInfo',
                '/model/lunar_pole_exploration_rover/haz_cam_right_front/camera_info@sensor_msgs/msg/CameraInfo@ignition.msgs.CameraInfo',
                '/model/lunar_pole_exploration_rover/haz_cam_right_rear/camera_info@sensor_msgs/msg/CameraInfo@ignition.msgs.CameraInfo',
